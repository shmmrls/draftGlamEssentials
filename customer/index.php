        ...
        <div class="category-grid">
            ...
            if ($categories_result && mysqli_num_rows($categories_result) > 0) {
                while ($category = mysqli_fetch_assoc($categories_result)) {
                    ...
                    $img_path = $baseUrl . '/assets/default.png'; // Default image
                    ...
                    if (!empty($category['img_name'])) {
                        ...
                        foreach ($extensions as $ext) {
                            ...
                            if (file_exists($fullPath)) {
                                $img_path = $baseUrl . '/item/product_category/' . $imgName . $ext;
                                break;
                            }
                        }
                    }
                    ...
                    if ($img_path === $baseUrl . '/assets/default.png') {
                        foreach ($extensions as $ext) {
                            $fullPath = $categoryImagesDir . 'category_' . $category_id . $ext;
                            if (file_exists($fullPath)) {
                                $img_path = $baseUrl . '/item/product_category/category_' . $category_id . $ext;
                                break;
                            }
                        }
                    }
